...
namespace TrackingSystemNew.Controllers
{
    public class ShipmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipmentNo,ShipmentStatus")] Shipment shipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShipmentNo,ShipmentStatus")] Shipment shipment)
        {
            if (ModelState.IsValid)
            {
